# This file is an adaptation of https://github.com/kunzhan/BrainGuard/blob/main/utils/data.py
...
class NSDDataset(Dataset):
    ...
    def _load_torch(self, torch_path):
        te = torch.load(torch_path, weights_only=True).to(torch.float32)[0]
        te.view(16,768)
        return te
    ...
    def __getitem__(self, idx):
        ...
        for ext in self.extensions:
            if ext == "jpg":
                ...
                items.append(self._load_torch(sample[ext]))
...
def get_dataloader(
        ...
        seed=42,
        is_shuffle=True,
        extensions=['nsdgeneral.npy', "jpg", 'ip'],
        pool_type=None,
        pool_num=None,
        length=None,
    ):
